  ...
  get: function() {
    ...
    if (this._privateRenderableInvoker) {
      ...
      console.log(
        ...
        'invokerInComponentsCollection: ', invokerInComponentsCollection,
        'invokerInPrivateCollection: ', invokerInPrivateCollection,
    ...
    console.log(
      ...
      'base: ', this.base,
      'base: ', this.baseRelativePath,
      'collectionGroup: ', this.collectionGroup,
      'collection: ', this.collection,
      'namespace: ', this.namespace,
      'name: ', this.name,
      'ext: ', this.ext, 'fileNameType: ', this._fileNameType,
      'type: ', this.type,
      'result: ', destRelativePath);
